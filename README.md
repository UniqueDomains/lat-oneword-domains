# Available .LAT One-Word Domains (8,448)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C451%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C448%20domains-6f42c1">
...
**Public extract:** 8,451 rows · **Live catalog:** 8,448 domains
...
- `lat.csv` — public CSV extract (8,451 rows)
- `lat.json` — public JSON extract (8,451 rows)
...
| alpha.lat      | premium   | $2,500    | $2,500        | 90             | 54     | 5      | name.com        |
...
| ----------------------- | ------------------------------------------------ |
| 8,451-row public sample | 8,448 live domains                               |
...
> Unique Domains. *Available .LAT One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
